...
//        //enhanced for loop
        ...
        //Fills every index with the same value
        ...
        // Uses the from/toIndex to change the value of the  the first 4 indexes to 5
        ...
        //Returns false because  the second value is different (lower case "m") in the words2 array
        ...
        // If you try to copy an array longer then the original it will give you default values.
        String[] badgerArray = new String[4];
        Arrays.fill(badgerArray, "Badgers");

        String[] twoBadgers = Arrays.copyOf(badgerArray, 7);
        ...
        // .sort defaults to alphabetical order.
